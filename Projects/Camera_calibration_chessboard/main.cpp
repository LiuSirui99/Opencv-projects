...
int main(int argc, char** argv)
{
 ...
 {
  //image load
  sprintf(str,"/Users/pingguo/Desktop/Affine_transformation/pattern/p%d.jpg", i+1 );
  printf("%s\n", str);
  Mat img = imread(str);
 ...
 //////////////////////////////////////////////////////////////////////////////////////////////////
 //save part
 fprintMatrix(intrinsic_Matrix, "/Users/pingguo/Desktop/Affine_transformation/pattern/intrinsic.txt");
 fprintMatrix(distortion_coeffs, "/Users/pingguo/Desktop/Affine_transformation/pattern/distortion_coeffs.txt");
