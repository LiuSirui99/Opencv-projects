...
int main( int argc, char** argv )
{
    ...
    Mat image;
    image = imread("/Users/pingguo/Desktop/Affine_transformation/Display_Image_Tutorial_Result.jpg");   // Read the file
    ...
    Mat tr3=createPerspectiveTraf(angle,0.4,200.0,200.0,1,1,0.0,0.0);
    transformImage(image,transformedImage,tr3,false);
    if(angle<=1){
        angle +=0.1;
        Mat tr4=createPerspectiveTraf(angle,0.4,200.0,200.0,1,1,0.0,0.0);
        transformImage(image,transformedImage,tr4,false);
